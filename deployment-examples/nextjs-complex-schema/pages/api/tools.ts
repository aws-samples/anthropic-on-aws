  ...
  tools: [
    {
      toolSpec: {
        ...
        description:
          'Use this tool to create a pizza orders. When creating the order determine the crust, size, toppings, extras and delivery details ',
        inputSchema: {
          json: {
            type: 'object',
            properties: {
            ...
            required: ['crust', 'size', 'toppings', 'customer_details'],
          },
        },
      },
    },
