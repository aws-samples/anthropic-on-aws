...
![GitHub last commit](https://img.shields.io/github/last-commit/your-username/cdk-knowledge-base)
![GitHub issues](https://img.shields.io/github/issues/your-username/cdk-knowledge-base)
![GitHub pull requests](https://img.shields.io/github/issues-pr/your-username/cdk-knowledge-base)
![License](https://img.shields.io/github/license/your-username/cdk-knowledge-base)
...
- [CDK Knowledge Base](#cdk-knowledge-base)
...
The CDK Knowledge Base project combines the power of Amazon Bedrock and AWS CDK to create a sophisticated document querying system. It allows users to upload PDF documents, process them using Amazon Bedrock's Knowledge Base feature, and query the content using natural language.
